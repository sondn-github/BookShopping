...
<?php
    ...
    if (isset($_POST["login"])) {
    	...
    	$sql = "SELECT * FROM user
    			WHERE ((user_mail = '$uid') AND (user_password = '$pwd'))";
		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb">
					<a href="home.php">Trang chủ</a> / <span>Đăng nhập</span>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input style="height: 35px" type="password" id="phone" name="password" required>
						</div>
						<div class="form-block">
